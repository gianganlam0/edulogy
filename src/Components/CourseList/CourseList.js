...
export default function CateList() {
    ...
    const [rateby, setRateby] = useState('rate');
    ...
    useEffect(() => {//take params from url
        ...
        if (!params.has('rateby') || params.get('rateby') === '') {
            setRateby('rate');
        }
                            ...
                            <Col xs={12} lg={6}>
                                <InputGroup className="mb-3">
                                    ...
                                    <Button onClick={()=>{
                                        ...
                                        setParams({page: 1, keyword: keywordRef.current.value, sortby: sortby, rateby: rateby, orderby: orderby});
                            ...
                            <Row>
                                ...
                                <Col className="right-text" xs={12} lg={{span: 2, offset: 3}}>
                                    <FloatingLabel className="mb-3" label="Tìm kiếm theo">
                                        <Form.Select value={sortby} onChange={(e)=>{setSortby(e.target.value); setParams({page: 1, keyword: keyword, sortby: e.target.value, rateby: rateby, orderby: orderby})}}>
                                ...
                                <Col className="right-text" xs={12} lg={2}>
                                    <FloatingLabel className="mb-3" label="Sắp xếp theo">
                                        <Form.Select value={rateby} onChange={(e)=>{setRateby(e.target.value); setParams({page: 1, keyword: keyword, sortby: sortby, rateby: e.target.value, orderby: e.target.value})}}>
                                ...
                                <Col className="right-text" xs={12} lg={2}>
                                    <FloatingLabel className="mb-3" label="Thứ tự">
                                        <Form.Select value={orderby} onChange={(e)=>{setOrderby(e.target.value); setParams({page: 1, keyword: keyword, sortby: sortby, rateby: rateby, orderby: e.target.value})}}>
                                ...
                                <InputGroup>
                                    ...
                                    <Button onClick={()=>{
                                        ...
                                        if(value > 0){
                                            ...
                                            setParams({page: 1, keyword: keyword, sortby: sortby, rateby: rateby, orderby: orderby});
                                        }
                                        else{
                                ...
                                <InputGroup>
                                    ...
                                    <Button onClick={()=>{
                                        ...
                                        if(value > 0 && value <= totalPage){
                                            setParams({page: value, keyword: keyword, sortby: sortby, rateby: rateby, orderby: orderby});
                                        }
                                        else{
